...
Recency (months) = st.sidebar.number_input("Recency (months) =", min_value=0, max_value=75)
Frequency (times)  = st.sidebar.number_input("Frequency (times)  =", min_value=0, max_value=50)
Monetary (c.c. blood)   = st.sidebar.number_input("Monetary (c.c. blood) =", min_value=0, max_value=11000)
Time (months)   = st.sidebar.number_input("Time (months) =", min_value=0, max_value=98)
whether he/she donated blood in March 2007   = st.sidebar.number_input("whether he/she donated blood in March 2007 =", min_value=0, max_value=0)
