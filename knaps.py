...
if submit :
    if algoritma == 'Decision Tree' :
        X_new = np.array([[Recency (months), Frequency (times), Monetary (c.c. blood), Time (months), whether he/she donated blood in March 2007]])
        ...
        X_new = np.array([[Recency (months), Frequency (times), Monetary s(c.c. blood), Time (months), whether he/she donated blood in March 2007]])
